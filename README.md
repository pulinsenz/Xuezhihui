...
| 功能模块   | 界面展示                                                     | 功能说明                                          |
| ---------- | :----------------------------------------------------------- | ------------------------------------------------- |
| AI 聊天    | ![image-20260824222020513](./assets/image-20260824222020513.png) | 基于 RAG 的智能问答界面，支持上下文对话和文档引用 |
| 知识库管理 | ![image-20260826205904523](./assets/image-20260826205904523.png) | 创建知识库、查看和编辑知识库                      |
| 公共知识库 | ![image-20260826205948681](./assets/image-20260826205948681.png) | 知识库添加与共享                                  |
| 文档切片   | ![image-20260826210019857](./assets/image-20260826210019857.png) | 上传文档管理，入库向量管理                        |
| 用户服务   | ![image-20260824222319751](./assets/image-20260824222319751.png) | 用户权限管理，用户删除                            |
